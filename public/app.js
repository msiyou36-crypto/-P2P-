...
function applyFilters() {
  ...
  const typeIsTx = f.type === 'deposit' || f.type === 'withdraw' || f.type === 'pay' || f.type === 'convert' || f.type === 'spot';
...
// خانة قابلة للتعديل للسعر/المبلغ — التعديل للمسؤول فقط ويبقى بعد المزامنة (P2P وحوالات)
